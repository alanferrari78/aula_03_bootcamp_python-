'''
#https://github.com/go4Mor4/Exericios-resolvidos_Estrutura-de-repeticao
...
while sexo not in ('m','f'):
    sexo = str(input("Digite seu sexo ('f' ou 'm') "));
estado_civil = str(input("Digite seu sexo ('s', 'c', 'v', 'd') "));
...
pop1 = float(input('Digite a menor população: '));
taxa1 = float(input('Digite a a taxa de crescimento da menor população: '));
pop2 = float(input('Digite a maior população: '))
while pop2 <= pop1:
    pop2 = float(input('Digite a maior população: '))
taxa2 = float(input('Digite a a taxa de crescimento da menor população: '))
while taxa2>= taxa1:
    taxa2 = float(input('Digite a a taxa de crescimento da menor população: '))
ano = 0
while pop1 < pop2:
