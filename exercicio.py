# x = int(input("Plesase enter an integer: "))
...
#
email = "alanfolha@gmail.com"
idade = 66
if not 18 <= idade <= 65:
    print("Verifique a idade")
elif "@" not in email or "." not in email:
    print("verifique o email")
else:
...
if transacao["valor"] >= 10000 or 9 < transacao["hora"] > 20:
    print("Suspeito")
else:
    print("Ok")
...
frase = "O meu amigo satriani, joey satriani"
...
#
usuarios = [
    {"nome": "Alice", "email": "alice@example.com", "chave": '1'},
    {"nome": "Bob", "email": "", "chave": ''},
    {"nome": "Carol", "email": "carol@example.com", "chave": ''},
    {"nome": "Alan", "email": "@", "chave": ''},
    {"nome": "Ferrari", "email": "@", "chave": ''},
    {"nome": "Luiz", "email": "", "chave": ''},
    {"nome": "Luizx","email": " ", "chave": ''}
]
print(usuarios)
usuarios_validos = [usuario for usuario in usuarios if usuario["chave"]]
